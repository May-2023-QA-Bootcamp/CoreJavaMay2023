...
public class UseOfArray04 {
	public static void main(String[] args) {
		...
		// Array is fixed size (Array is static), but line 37, name is b
		// how we can increase the length of an Array? [Important]
		// Array name is b 
		int [] b = Arrays.copyOf(a, 10);
		// second argument: declaring size of new array along with old Array Name [b] and new length, here is 10
		
		// Is the length changed?
		// Is the length changed? line 30 is for line 41 comparison
