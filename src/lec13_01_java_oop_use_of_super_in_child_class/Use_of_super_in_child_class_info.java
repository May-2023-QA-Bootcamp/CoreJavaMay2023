...
If a child class extends a superclass, which constructor is initialized in child class without writing super()? (not teached in the class)
...
public class Use_of_super_in_child_class_info {
